...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">Fernando Mora DevOps Container Lab</a>
        </div>
...
<div class="jumbotron">
    <div class="container">
        <h1>Hola</h1>
        <p>Este es mi laboratorio de pruebas DevOps</p>
        <p><a class="btn btn-primary btn-lg" role="button">Aprende mas &raquo;</a></p>
        <p><a class="btn btn-primary btn-lg" role="button">Exitos!! more &raquo;</a></p>
        <p><a class="btn btn-primary btn-lg" role="button">Unete!! &raquo;</a></p>
    </div>
</div>
